...
if (isset($_POST['create_account'])) {
    ...
    $query_sel = mysqli_query($con, "SELECT * FROM `users` WHERE `email`= '$email'");
...
?>
        ...
        $create = mysqli_query($con, "INSERT INTO users(name,email,contactno,password) values('$full_name','$email','$tel','$password') ");
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="full_name" placeholder="" id="FirstName" autofocus="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="LastName">Tel</label>
                                            <input type="text" name="tel" placeholder="" id="LastName">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" value="" id="password1" name="password" placeholder="" id="CustomerPassword" class="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="CustomerPassword">Comfirm Password</label>
                                            <input type="password" value="" id="password2" name="password" placeholder="" id="CustomerPassword" class="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                        <input type="submit" name="create_account" class="btn mb-3" value="Create">
                                    </div>
                                </div>
                            </form>
                        </div>
