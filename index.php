    ...
    <ul id="MobileNav" class="mobile-nav">
            ...
            <ul>
                <li><a href="product-layout-1.php" class="site-nav">Product Page<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="product-with-left-thumbs.php" class="site-nav">Product With Left
                                Thumbs</a></li>
                        <li><a href="product-with-right-thumbs.php" class="site-nav">Product With Right
                                Thumbs</a></li>
                        <li><a href="product-with-bottom-thumbs.php" class="site-nav last">Product With Bottom
                                Thumbs</a></li>
                    </ul>
                </li>
                <li><a href="short-description.php" class="site-nav">Product Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="product-quantity-message.php" class="site-nav">Product Quantity
                                Message</a></li>
                        <li><a href="product-visitor-sold-count.php" class="site-nav">Product Visitor/Sold
                                Count </a></li>
                        <li><a href="product-zoom-lightbox.php" class="site-nav last">Product Zoom/Lightbox
                            </a></li>
                    </ul>
                </li>
                <li><a href="#" class="site-nav">Product Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="product-with-variant-image.php" class="site-nav">Product with Variant
                                Image</a></li>
                        <li><a href="product-with-color-swatch.php" class="site-nav">Product with Color
                                Swatch</a></li>
                        <li><a href="product-with-image-swatch.php" class="site-nav">Product with Image
                                Swatch</a></li>
                        <li><a href="product-with-dropdown.php" class="site-nav">Product with Dropdown</a></li>
                        <li><a href="product-with-rounded-square.php" class="site-nav">Product with Rounded
                                Square</a></li>
                        <li><a href="swatches-style.php" class="site-nav last">Product Swatches All Style</a>
                        </li>
                    </ul>
                </li>
                <li><a href="#" class="site-nav">Product Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="product-shipping-message.php" class="site-nav">Product Shipping
                                Message</a></li>
        ...
        <!-- <li class="lvl1 parent megamenu"><a href="about-us.php">Pages <i class="anm anm-plus-l"></i></a>
            <ul>
                ...
                <li><a href="checkout.php" class="site-nav">Checkout</a></li>
                <li><a href="about-us.php" class="site-nav">About Us<span class="lbl nm_label1">New</span></a>
                </li>
        ...
        <div class="home-slideshow">
            <div class="slide">
                <div class="blur-up lazyload bg-size">
                    <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/home3-banner-mobile.JPG" src="assets/images/slideshow-banners/home3-banner-mobile.JPG" alt="Shop Our New Collection" title="Shop Our New Collection" />
            ...
            <div class="slide">
                <div class="blur-up lazyload bg-size">
                    <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/belle-banner1.jpg" src="assets/images/slideshow-banners/belle-banner1.jpg" alt="Summer Bikini Collection" title="Summer Bikini Collection" />
                    <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                        <div class="slideshow__text-content bottom">
                            <div class="wrap-caption center">
                        ...
                        <div class="tab_container">
                            <div id="tab1" class="tab_content grid-products">
                                <div class="productSlider">
                                    ...
                                    <?php
                                    $select_cat = mysqli_query($con, "SELECT * FROM `category` WHERE `categoryName`='men'");

                                    while ($row = mysqli_fetch_array($select_cat)) {
                                        $cat_id = $row[0];
                                    }
                                    // fetch products
                                    $select_pro = mysqli_query($con, "SELECT * FROM `products` where category='$cat_id'");
                                    if (mysqli_num_rows($select_pro) == 0) {
                                    ?>
                                        <h1>No product</h1>
                                    <?php
                                    }
                                    while ($row1 = mysqli_fetch_array($select_pro)) {
                                        $prod_id = $row1['id'];
                                    ?>
                                ...
                                <div class="productSlider">
                                    <div class="col-12 item">
                                        ...
                                        <div class="product-details text-center">
                                            <!-- product name -->
                                            <div class="product-name">
                                                <a href="short-description.php">Azur Bracelet in Blue
                                                    Azurite</a>
                                            </div>
                                            <!-- End product name -->
                                            <!-- product price -->
            ...
            <div class="collection-grid">
                <div class="collection-grid-item">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img data-src="assets/images/prod/t2.jfif" src="assets/images/prod/t2.jfif" alt="Jewellry" class="blur-up lazyload" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                            <h3 class="collection-grid-item__title btn btn--secondary no-border">T-Shrit</h3>
                        </div>
                    </a>
                </div>
                <div class="collection-grid-item">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img data-src="assets/images/prod/w.jpg" src="assets/images/prod/w.jpg" alt="Fashion" class="blur-up lazyload" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img class="blur-up lazyload" data-src="assets/images/prod/j4.jfif" src="assets/images/prod/j4.jfif" alt="Cosmetic" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                            <h3 class="collection-grid-item__title btn btn--secondary no-border">Jeans</h3>
                        </div>
                    </a>
                </div>
                <div class="collection-grid-item blur-up lazyloaded">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img data-src="assets/images/collection/bag.jpg" src="assets/images/collection/bag.jpg" alt="Bag" class="blur-up lazyload" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img data-src="assets/images/prod/v1.jpg" src="assets/images/prod/v1.jpg" alt="Accessories" class="blur-up lazyload" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                            <h3 class="collection-grid-item__title btn btn--secondary no-border">T-Shrit
                            </h3>
                        </div>
                    </a>
                </div>
                <div class="collection-grid-item">
                    <a href="collection-page.php" class="collection-grid-item__link">
                        <img data-src="assets/images/collection/shoes.jpg" src="assets/images/collection/shoes.jpg" alt="Shoes" class="blur-up lazyload" height="300" />
                        <div class="collection-grid-item__title-wrapper">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-single__meta">
                                    ...
                                    <div class="product-single__description rte">
                                        xxxxxxxxx xxxxxxxx xxxxxx xxxxxxxxxx xxxxxx xxx xxxxxxxx xxxxxxxxxxxxxx
                                        xxxxxxxxxx xxxxxxxxx xxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxx xxxxxxxxx
                                        xxxxxxxxxx xxxxxxxx xxxxxxxxxx xxxxxxxx xxxxxxxxxxxxxxx xxxxxxxx
                                    </div>
